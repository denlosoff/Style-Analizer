...
const AppContent: React.FC = () => {
    ...
    const handleSaveAxis = (axisToSave: Axis, generatedScores: Record<string, number> | null) => {
        if (!spaceData) return;
        let isNew = false;
        ...
        // Open the scoring wizard for a new axis ONLY if scores weren't generated by AI
        if (isNew && !generatedScores) {
