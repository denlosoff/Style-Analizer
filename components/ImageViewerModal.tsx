                        ...
                        <div ref={thumbnailContainerRef} className="flex p-2 space-x-2 bg-gray-900 rounded-md overflow-x-auto">
                           {images.map((img, index) => (
                                <img
                                    ...
                                    className={`w-20 h-20 object-cover rounded cursor-pointer border-2 flex-shrink-0 transition-all ${currentIndex === index ? 'border-blue-500 scale-105' : 'border-transparent hover:border-gray-500'}`}
